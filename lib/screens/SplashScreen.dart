...
class _SplashScreenState extends State<SplashScreen> {
  ...
  GoToLoginScreen() async {
    ...
    if (result != null) {
      ...
      UserData.phone=sharepref.getString("phone");
      ...
      Future.delayed(Duration(seconds: 1)).then((value) => {
        ...
        //Get.offAll use korle Navigatior er moto kaj kore akhane mainBottomNavBarScreen a jabe
    ...
    //akhane jodi token er vlaue null na thake tahole MainBottomNavBarScreen   a jabe
      ...
      Future.delayed(Duration(seconds: 1)).then((value) =>
          ...
          //pushAndRemoveUntil use korle back page a ar asa jaina
          {
            //Get.offAll use korle Navigatior er moto kaj kore
